...
var browser = new (require('ua-parser-js'))().getBrowser();
...
// CSVのMIME TYPE
var types = ['text/csv', 'text/comma-separated-values', 'text/plain', 'application/csv', 'application/excel', 'application/vnd.ms-excel', 'application/vnd.msexcel', 'text/anytext'];

var codeArray = undefined;
...
function output() {
  // 8ビット符号なし整数値の配列に変換
  var uint8Array = new Uint8Array(codeArray);
  // MIMEType指定
...
},{"encoding-japanese":2,"ua-parser-js":3}],2:[function(require,module,exports){
/**
 * Encoding.js
 *
